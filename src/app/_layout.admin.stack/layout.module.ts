...
// layout
import { LayoutAdminStackComponent } from './layout.component';
...
import { LayoutAdminStackSignInComponent } from './signin/layout.signin.component';
...
@NgModule({
    ...
    declarations: [
        ...
        LayoutAdminStackComponent,
        LayoutQuickPanelComponent,
        LayoutHeaderMobileComponent,
        LayoutAdminStackSignInComponent,
    ],
    exports: [
        LayoutAsideComponent,
        LayoutHeaderComponent,
...
export class LayoutAdminStackModule { }

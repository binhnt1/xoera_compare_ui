...
import { S40RequestData } from '../../../../_core/domains/entities/hubfile.entity';

@Component({
    templateUrl: './popup.s40.request.component.html',
    styleUrls: ['./popup.s40.request.component.scss'],
})
export class PopupS40RequestComponent implements OnInit {
    result: any;
    siteId: number;
    errorMessage: string;
    @Input() params: any;
    service: SiteService;
    item: S40RequestData = new S40RequestData();

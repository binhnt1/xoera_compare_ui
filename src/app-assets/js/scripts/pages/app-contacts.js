            ...
            '<a data-toggle="modal" data-target="#EditContactModal" class="primary edit mr-1"><i class="fa fa-pencil"></i></a>'+
                ...
                '<span class="dropdown">'+
                    ...
                    '<span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">'+
                        ...
                        '<a class="dropdown-item delete"><i class="feather icon-trash-2"></i> Delete</a>'+
                        '<a class="dropdown-item"><i class="feather icon-plus-circle primary"></i> Projects</a>'+
                        '<a class="dropdown-item"><i class="feather icon-plus-circle info"></i> Team</a>'+
                        '<a class="dropdown-item"><i class="feather icon-plus-circle warning"></i> Clients</a>'+
                        '<a class="dropdown-item"><i class="feather icon-plus-circle success"></i> Friends</a>'+
                    '</span>'+
                '</span>'
        ] ).draw( false );

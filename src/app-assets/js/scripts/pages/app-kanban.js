  ...
  addBoardDefault.addEventListener("click", function () {
    ...
    if (kanbanNewBoard) {
      ...
      kanbanNewBoardData =
        ...
        '<a class="dropdown-item"><i class="feather icon-link mr-50"></i>Copy Link</a>' +
        '<a class="dropdown-item kanban-delete" id="kanban-delete"><i class="feather icon-trash-2 mr-50"></i>Delete</a>' +
        "</div>" + "</div>";
